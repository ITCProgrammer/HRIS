        ...
        <div style="background:#f9f9f9;background-color:#f9f9f9;Margin:0px auto;max-width:600px;">
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
                ...
                <tbody>
                    <tr>
                        <td
                            style="border-bottom:#18caed solid 10px;direction:ltr;font-size:0px;padding:20px 0;text-align:center;vertical-align:top;">
                        </td>
                    </tr>
                </tbody>
            </table>
                                            ...
                                            <table align="center" border="0" cellpadding="0" cellspacing="0"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="width:70px;">
                                                            <img height="auto"
                                                                src="{{ $message->embed(public_path('img/happy-birthday.png')) }}"
                                    ...
                                    <tr>
                                        <td align="left"
                                            ...
                                            <div
                                                ...
                                                Kepada yang terkasih,<br>
                                                Sdr/Sdri : {{ $name }}<br><br>
                                                Selamat ulang tahun yang ke-{{ $age }}. Selamat menikmati hari
                                                bahagia ini. Semoga dengan bertambah usia, anda akan dipenuhi dengan
                                                kebahagiaan dan
                                                kasih bersama dengan keluarga dan orang-orang terdekat. Terimakasih atas
                                                segala kerja keras dan komitmen yang telah anda berikan kepada
                                                Perusahaan.
                                                Sekali lagi, Selamat Ulang Tahun.<br><br>
